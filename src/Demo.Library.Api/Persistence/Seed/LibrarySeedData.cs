...
internal static class LibrarySeedData
{
    public static void Seed(WebApplication app)
    {
        ...
        db.Books.AddRange(
            ...
            new Book { Isbn = "978-1617294532", Title = "Concurrency in C# Cookbook", Author = "Stephen Cleary", TotalCopies = 2, AvailableCopies = 2 },
            new Book { Isbn = "978-1098113322", Title = "Designing Data-Intensive Applications", Author = "Martin Kleppmann", TotalCopies = 2, AvailableCopies = 2 },
            new Book { Isbn = "978-0131103627", Title = "The C Programming Language", Author = "Brian W. Kernighan", TotalCopies = 1, AvailableCopies = 1 },
            new Book { Isbn = "978-0132350884", Title = "Clean Code", Author = "Robert C. Martin", TotalCopies = 4, AvailableCopies = 4 },
            new Book { Isbn = "978-0134494166", Title = "Clean Architecture", Author = "Robert C. Martin", TotalCopies = 3, AvailableCopies = 3 },
            new Book { Isbn = "978-0201633610", Title = "Design Patterns", Author = "Erich Gamma", TotalCopies = 2, AvailableCopies = 2 },
            new Book { Isbn = "978-1492056812", Title = "Software Architecture: The Hard Parts", Author = "Neal Ford", TotalCopies = 2, AvailableCopies = 2 },
            new Book { Isbn = "978-1617296277", Title = "Microservices Patterns", Author = "Chris Richardson", TotalCopies = 3, AvailableCopies = 3 },
